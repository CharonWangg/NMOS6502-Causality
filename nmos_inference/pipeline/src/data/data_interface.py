...
class DataInterface(pl.LightningDataModule):
    ...
    def train_dataloader(self):
        return DataLoader(self.trainset, batch_size=self.hparams.train_batch_size, num_workers=self.hparams.num_workers, shuffle=True)

    def val_dataloader(self):
        return DataLoader(self.valset, batch_size=self.hparams.valid_batch_size, num_workers=self.hparams.num_workers, shuffle=False)

    def test_dataloader(self):
        return DataLoader(self.testset, batch_size=self.hparams.test_batch_size, num_workers=self.hparams.num_workers, shuffle=False)

    def predict_dataloader(self):
        return DataLoader(self.predictset, batch_size=self.hparams.test_batch_size, num_workers=self.hparams.num_workers, shuffle=False)
